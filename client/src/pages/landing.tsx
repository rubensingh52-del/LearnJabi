...
const lessonCards = [
  ...
  },
  {
    ...
    desc: "Learn all the colours and descriptive words in Punjabi",
    accent: "text-purple-500",
    border: "border-purple-500/20",
    preview: [{ p: "ਲਾਲ", r: "Laal", e: "Red" }, { p: "ਨੀਲਾ", r: "Neela", e: "Blue" }, { p: "ਹਰਾ", r: "Haraa", e: "Green" }],
  },
  {
    emoji: "📍",
    tag: "Unit 5",
    title: "Directions & Places",
    desc: "Navigate places, ask for directions, and travel vocabulary",
  ...
  },
  {
    ...
    accent: "text-orange-500",
    border: "border-orange-500/20",
    preview: [{ p: "ਖੁਸ਼", r: "Khush", e: "Happy" }, { p: "ਉਦਾਸ", r: "Udaas", e: "Sad" }, { p: "ਥੱਕਿਆ", r: "Thakiya", e: "Tired" }],
  },
  {
    emoji: "👨‍👩‍👧",
    tag: "Unit 7",
    title: "Family & People",
    desc: "Talk about family members, relationships, and respect",
  ...
  },
  {
    ...
    tag: "Unit 8",
    title: "Food & Dining",
    desc: "Order food, discuss Punjabi cuisine, and cooking vocabulary",

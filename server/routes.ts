    ...
    const newUnit1Lessons = [
      ...
      { 
        ...
        content: JSON.stringify({ 
          ...
          items: [ 
            { gurmukhi: "ਸ਼", romanized: "shashashaa", english: "The little dot underneath adds an 'h' sound — it turns the 's' into 'sh' (like 'Shop')" }, 
            { gurmukhi: "ਖ਼", romanized: "khhakhhkhha", english: "The little dot underneath adds a scratchy sound — it turns 'kh' into a deep 'kh' (like 'Loch')" }, 
            { gurmukhi: "ਗ਼", romanized: "ghagghaa", english: "The little dot underneath adds a gurgling sound — it turns 'g' into a deep 'g'" }, 
            { gurmukhi: "ਜ਼", romanized: "zazzaa", english: "The little dot underneath adds a 'z' sound — it turns 'j' into 'z' (like 'Zebra')" }, 
            { gurmukhi: "ਫ਼", romanized: "faffaa", english: "The little dot underneath adds an 'f' sound (like 'f' in 'Fan')" }, 
            { gurmukhi: "ਲ਼", romanized: "lallaa", english: "The little dot underneath adds a 'curl' to the 'l' sound (curl your tongue back)" }, 
            { gurmukhi: "ਾ", romanized: "kannaa", english: "This symbol adds an 'aa' sound to any letter (like 'a' in Father)" }, 
            { gurmukhi: "ਿ", romanized: "sihaaree", english: "This symbol adds a short 'i' sound to any letter (like 'i' in It)" }, 
            { gurmukhi: "ੀ", romanized: "bihaaree", english: "This symbol adds a long 'ee' sound to any letter (like 'ee' in See)" }, 
            { gurmukhi: "ੁ", romanized: "aunkarh", english: "This symbol adds a short 'u' sound to any letter (like 'u' in Put)" }, 
            { gurmukhi: "ੂ", romanized: "dulainkarh", english: "This symbol adds a long 'oo' sound to any letter (like 'oo' in Food)" }, 
            { gurmukhi: "ੇ", romanized: "laavaan", english: "This symbol adds an 'ay' sound to any letter (like 'ay' in Play)" }, 
            { gurmukhi: "ੈ", romanized: "dulaavaan", english: "This symbol adds an 'a' sound to any letter (like 'a' in Man)" }, 
            { gurmukhi: "ੋ", romanized: "horhaa", english: "This symbol adds an 'o' sound to any letter (like 'o' in Go)" }, 
            { gurmukhi: "ੌ", romanized: "kanaurhaa", english: "This symbol adds an 'au' sound to any letter (like 'au' in Caught)" } 
          ], 
          exercises: [ 

      ...
      { 
        ...
        content: JSON.stringify({ 
          ...
          items: [ 
            ...
            { gurmukhi: "ਾ", romanized: "kannaa", english: "Adds a long 'aa' sound — like the 'a' in Father" }, 
            { gurmukhi: "ਿ", romanized: "sihaaree", english: "Adds a short 'i' sound — like the 'i' in It" }, 
            { gurmukhi: "ੀ", romanized: "bihaaree", english: "Adds a long 'ee' sound — like the 'ee' in See" }, 
            { gurmukhi: "ੁ", romanized: "aunkarh", english: "Adds a short 'u' sound — like the 'u' in Put" }, 
            { gurmukhi: "ੂ", romanized: "dulainkarh", english: "Adds a long 'oo' sound — like the 'oo' in Food" }, 
            { gurmukhi: "ੇ", romanized: "laavaan", english: "Adds the 'ay' sound to a letter — like the 'ay' in Play" }, 
            { gurmukhi: "ੈ", romanized: "dulaavaan", english: "Adds the 'a' sound to a letter — like the 'a' in Man" }, 
            { gurmukhi: "ੋ", romanized: "horhaa", english: "Adds an 'o' sound — like the 'o' in Go" }, 
            { gurmukhi: "ੌ", romanized: "kanaurhaa", english: "Adds an 'au' sound — like the 'au' in Caught" } 
          ], 
          exercises: [ 
